...
<div class="box">
	...
	<div class="box_right">
    	<a href="list_pm.php">Your messages(<?php echo $nb_new_pm; ?>)</a> - <a href="profile.php?id=<?php echo $_SESSION['userid']; ?>"><?php echo htmlentities($_SESSION['username'], ENT_QUOTES, 'UTF-8'); ?></a> (<a href="login1.php">Logout</a>)
    </div>
	<div class="clean"></div>
</div>
<?php
...
<div class="box">
	...
	<div class="box_right">
    	<a href="signup.php">Sign Up</a> - <a href="login1.php">Login</a>
    </div>
	<div class="clean"></div>
</div>
<?php
