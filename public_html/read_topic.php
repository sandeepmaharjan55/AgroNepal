...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
    	<div class="header">
        	<center><a href="<?php echo $url_home; ?>"><img src="<?php echo $design; ?>/images/logo.png" alt="Forum" /></a>
	    </center></div>
        <div class="content">
<?php
...
<div class="box">
	<div class="box_left">
    	<a href="forum.php">Forum Index</a> &gt; <a href="list_topics.php?parent=<?php echo $dn1['parent']; ?>"><?php echo htmlentities($dn1['name'], ENT_QUOTES, 'UTF-8'); ?></a> &gt; <a href="read_topic.php?id=<?php echo $id; ?>"><?php echo htmlentities($dn1['title'], ENT_QUOTES, 'UTF-8'); ?></a> &gt; Read the topic
    </div>
...
?><br /><a href="profile.php?id=<?php echo $dnn2['authorid']; ?>"></a></td>
...
{
	echo '<h1>The ID of this topic is not defined.</h1>';
}
?>
<?php
include('footer.php');
