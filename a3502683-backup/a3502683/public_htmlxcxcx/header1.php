                  ...
                  <div class="wrapper">
                           <div class="top_nav">
                              <ul>
                                ...
                                <li><div id="profile"><b id="logout"><a href="logout.php">Log Out</a></b>
<b id="welcome"><font color="#FFFFFF">Welcome :</font> <i><font color="#D0F0C0"><?php echo $_SESSION['SESS_FIRST_NAME']; ?></font></i></b>
                           ...
                           <div class="header-mid">
                             ...
                             <div class="social_site">
                                <ul>
                                      <li>
                                        <div class="circle"><a href="#"><img src="pic/fb.png" /></a></div>
                                      </li>
                                      <li>
                                        <div class="circle"><a href="#"><img src="pic/google.png" /></a></div>
                                      </li>
                                      <li>
                                        <div class="circle"><a href="#"><img src="pic/in.png" /></a></div>
                                      </li>
                                      <li>
                                        <div class="circle"><a href="#"><img src="pic/twitter.png"  /></a></div>
                                      </li>
